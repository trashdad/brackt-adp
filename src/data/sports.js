const SPORTS = [
  ...
  { id: 'csgo', name: 'Counter-Strike 2', apiKey: 'esports_csgo', category: 'standard', eventsPerSeason: 4, market: 'outrights', icon: '\u{1F3AE}', active: true, scarcityWeight: 0.4, tournaments: [{ id: 'blast-spring-2026', name: 'BLAST Open Spring (Rotterdam)' }, { id: 'cologne-2026', name: 'IEM Cologne Major' }, { id: 'blast-fall-2026', name: 'BLAST Open Fall (Copenhagen)' }, { id: 'singapore-2026', name: 'PGL Singapore Major' }] },
