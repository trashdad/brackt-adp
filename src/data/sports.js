const SPORTS = [
  ...
  { id: 'csgo', name: 'Counter-Strike 2', apiKey: 'esports_csgo', category: 'standard', eventsPerSeason: 4, market: 'outrights', icon: '\u{1F3AE}', active: true, scarcityWeight: 0.4, fieldSize: 24, tournaments: [{ id: 'blast-spring-2026', name: 'BLAST Open Spring (Rotterdam)' }, { id: 'cologne-2026', name: 'IEM Cologne Major' }, { id: 'blast-fall-2026', name: 'BLAST Open Fall (Copenhagen)' }, { id: 'singapore-2026', name: 'PGL Singapore Major' }] },
  ...
  { id: 'pga', name: 'PGA Golf', apiKey: 'golf_pga', category: 'standard', eventsPerSeason: 4, market: 'outrights', icon: '\u26F3', active: true, scarcityWeight: 0.2, fieldSize: 80, tournaments: [{ id: 'masters', name: 'The Masters' }, { id: 'pga-champ', name: 'PGA Championship' }, { id: 'us-open', name: 'US Open' }, { id: 'open-champ', name: 'The Open Championship' }] },
  ...
  { id: 'tennis_m', name: 'Tennis (Men\'s)', apiKey: 'tennis_atp', category: 'standard', eventsPerSeason: 4, market: 'outrights', icon: '\u{1F3BE}', active: true, scarcityWeight: 0.4, fieldSize: 64, tournaments: [{ id: 'aus-open', name: 'Australian Open' }, { id: 'french-open', name: 'French Open' }, { id: 'wimbledon', name: 'Wimbledon' }, { id: 'us-open', name: 'US Open' }] },
  { id: 'tennis_w', name: 'Tennis (Women\'s)', apiKey: 'tennis_wta', category: 'standard', eventsPerSeason: 4, market: 'outrights', icon: '\u{1F3BE}', active: true, scarcityWeight: 0.4, fieldSize: 64, tournaments: [{ id: 'aus-open', name: 'Australian Open' }, { id: 'french-open', name: 'French Open' }, { id: 'wimbledon', name: 'Wimbledon' }, { id: 'us-open', name: 'US Open' }] },
